    ...
    return (
        <header className={styles['nav-container']}>
            <div id={styles["logo-div"]}>
                <h1 id={styles["logo-text"]}><Link  href="/"><a id={styles["logo-link"]}><FontAwesomeIcon icon={faCode} /> DaveyLoper Blog</a></Link></h1>
            </div>
            ...
            <button onClick={toggleNavbar} className={styles.mobileNavbarButton}> Nav </button>
